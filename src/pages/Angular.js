        ...
        <div>
            <div class="p-4 sm:ml-64">
                <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
                    <div>
                        <p className='text-lg text-center'>Dockerizing the Angular Application</p>
                    </div>
                        ...
                        <div>
                            <pre className="whitespace-pre-wrap">
                                <code className="text-sm text-red-400">
                                    ...
                                    COPY . . {"\n"}
                                    <p className='text-white text-sm'># Install Angular CLI globally</p>
                                    RUN npm install -g @angular/cli {"\n"}
                                    <p className='text-white text-sm'># Build the Angular app for production</p>
                                    RUN ng build {"\n"}
                                    <p className='text-white text-sm'># Expose port 4200 (default port for Angular development server)</p>
                                    EXPOSE 4200 {"\n"}
                                    <p className='text-white text-sm'># Start the Angular development server</p>
                        ...
                        <ol>
                            ...
                            <li className='list-decimal'>Base Image:
                                <ul className='px-5'>
                                    <li className='list-disc'>
                                        The  <strong className='text-md font-medium text-red-400 cursor-pointer'>` node:21-alpine `</strong> is used
                                        as the base image for building the Angular application.
                                    </li>
                            ...
                            <li className='list-decimal'>
                                ...
                                <ol className='px-5'>
                                    ...
                                    <li className='list-disc'>
                                        The command <strong className='text-md font-medium text-red-400 cursor-pointer'>
                                            ` RUN npm install -g @angular/cli `</strong> installs the Angular CLI globally within the container.
                            ...
                            <li className='list-decimal'>
                                ...
                                <ol className='px-5'>
                                    <li className='list-disc'>
                                        Port 4200 is exposed using <strong className='text-md font-medium text-red-400 cursor-pointer'>
                                            ` EXPOSE 4200 `</strong> , enabling access to the Angular application over the web.
                                    </li>
                                </ol>
                            </li>
                                ...
                                <ol className='px-5'>
                                    <li className='list-disc'>
                                        The  <strong className='text-md font-medium text-red-400 cursor-pointer'>
                                            ` CMD ["ng", "serve", "--host", "0.0.0.0"]  `</strong> instruction specifies the command to start the Angular Application and
                    ...
                    <div className='mt-8'>
                        ...
                        <ol className='list-decimal px-5 mt-3'>
                            ...
                            <li>Navigate to the directory containing your Dockerfile and the Angular project files.</li>
                            ...
                            <li>Access your Angular application by opening a web browser and navigating to <strong className='text-md font-medium text-red-400 cursor-pointer'> http://localhost:4200 </strong>.</li>
                            <li>Refer the Github Project</li>
                            <div className="max-w-xl bg-gray-800 m-4 text-white italic p-4 rounded-lg">
                                <a
                                    href='https://github.com/Manojkumar1709/Angular-Application.git'
                                    target='_blank'
                                    rel="noreferrer"
                                >
                                    https://github.com/Manojkumar1709/Angular-Application.git
                                </a>
                            </div>
                        </ol>
                    </div>
