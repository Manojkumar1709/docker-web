        ...
        <div>
            <div className="p-4 sm:ml-64">
                <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
                    <div>
                        <p className='text-lg text-center'>Dockerizing the NextJS Application</p>
                    </div>
                        ...
                        <div>
                            <pre className="whitespace-pre-wrap">
                                <code className="text-sm text-red-400">
                                    ...
                                    COPY . . {"\n"}
                                    <p className='text-white text-sm'># Build the Next.js application</p>
                                    RUN npm run build {"\n"}
                                    <p className='text-white text-sm'># Expose the port on which the Next.js application will run</p>
                                    EXPOSE 3000 {"\n"}
                                    <p className='text-white text-sm'># Start the Next.js application</p>
                                    CMD ["npm", "start"] {"\n"}
                        ...
                        <ol>
                            ...
                            <li className='list-decimal'>Base Image:
                                <ul className='px-5'>
                                    <li className='list-disc'>
                                        The  <strong className='text-md font-medium text-red-400 cursor-pointer'>` node:20-alpine `</strong> is used
                                        as the base image for building the NextJS application.
                                    </li>
                            ...
                            <li className='list-decimal'>
                                ...
                                <ol className='px-5'>
                                    ...
                                    <li className='list-disc'>
                                        The NextJS application code is copied into the container with <strong className='text-md font-medium text-red-400 cursor-pointer'>
                                            ` COPY . . `</strong>.
                                    </li>
                                    <li className='list-disc'>
                            ...
                            <li className='list-decimal'>
                                ...
                                <ol className='px-5'>
                                    <li className='list-disc'>
                                        Port 3000 is exposed using <strong className='text-md font-medium text-red-400 cursor-pointer'>
                                            ` EXPOSE 3000 `</strong> , enabling access to the NextJS application over the web.
                                    </li>
                                </ol>
                            </li>
                                ...
                                <ol className='px-5'>
                                    <li className='list-disc'>
                                        The  <strong className='text-md font-medium text-red-400 cursor-pointer'>
                                            ` CMD ["npm", "start"] `</strong>  instruction specifies the command to start the NextJS Application and
                    ...
                    <div className='mt-8'>
                        ...
                        <ol className='list-decimal px-5 mt-3'>
                            ...
                            <li>Navigate to the directory containing your Dockerfile and the NextJS project files.</li>
                            ...
                            <li>Access your NextJS application by opening a web browser and navigating to <strong className='text-md font-medium text-red-400 cursor-pointer'> http://localhost:3000 </strong>.</li>
                            <li>Refer the Github Project</li>
                            <div className="max-w-xl bg-gray-800 m-4 text-white italic p-4 rounded-lg">
                                <a
                                    href='https://github.com/Manojkumar1709/NextJS-Application.git'
                                    target='_blank'
                                    rel="noreferrer"
                                >
                                    https://github.com/Manojkumar1709/NextJS-Application.git
                                </a>
                            </div>
                        </ol>
                    </div>
